 ...
 * ------------------------------------------------------------------------*/
require_once (PEXETO_FUNCTIONS_PATH.'bfi-thumb.php');  //image resizing script
...
if(is_admin()){
	require_once (PEXETO_FUNCTIONS_PATH.'upload-handler.php');  //upload form functionality
}
if(!is_admin()){
...
function pexeto_print_admin_scripts(){
	...
	if ( current_user_can( 'edit_posts' ) ) {
		...
		$script.='PEXETO.uploadUrl="'.$uploads_url.'"';
	}
	$script.='</script>';
	echo $script;
}
